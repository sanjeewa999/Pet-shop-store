...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
            <?php $sql="SELECT * FROM product , category WHERE category.category_id = product.category_id AND category.category_name = 'calcium supplements'";
